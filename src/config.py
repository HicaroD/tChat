...
class InvalidOAuthToken(Exception):
    ...
    """
    def __init__(self, message="Invalid OAuth token. The token should looks like this: 'oauth:0smq58szgnf58ti7h12382askda31o'"):
...
class Configuration:
    ...
    def make_config_file(self):
        try:
            ...
            print("You can directly insert your oauth token in the .cfg stored in src/, with no extra spaces in the file")
